...
import { FormFeedback, Input, InputGroup, InputGroupAddon, FormGroup, Label, Row, Col } from 'reactstrap';
...
var RkInput = function (_Component) {
  ...
  createClass(RkInput, [{
    ...
    value: function render() {
      ...
      var conteInput = null;
      var input = React.createElement(Input, _extends({}, localProps, { onFocus: this.showErrorTooltip, onBlur: this.hiddenErrorTooltip, onChange: this.changeValue, valid: valid, invalid: invalid }));
      var prepend = _prepend ? React.createElement(
        InputGroupAddon,
        { addonType: 'prepend' },
        _prepend
      ) : null;
      var append = _append ? React.createElement(
        InputGroupAddon,
        { addonType: 'append' },
        _append
      ) : null;
      if (append == null && prepend == null) {
        ...
        conteInput = React.createElement(
          InputGroup,
...
var RkMultiSelect = function (_Component) {
  ...
  createClass(RkMultiSelect, [{
    ...
    value: function render() {
      ...
      var conteInput = null;
      var input = React.createElement(Select, _extends({}, localProps, {
...
var RkMultiSelectAdd = function (_Component) {
  ...
  createClass(RkMultiSelectAdd, [{
    ...
    value: function render() {
      ...
      var conteInput = null;
      var input = React.createElement(CreatableSelect, _extends({}, localProps, {
        isClearable: true,
...
var RkDatetime = function (_Component) {
  ...
  createClass(RkDatetime, [{
    ...
    value: function render() {
      ...
      var conteInput = null;
      var input = React.createElement(Datetime, _extends({}, localProps, {
        locale: 'es',
  ...
  createClass(RkSwitch, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(Switch, _extends({}, localProps, { onChange: this.changeValue }))
      );
    }
  }]);
  return RkSwitch;
  ...
  createClass(RkCheckbox, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(Input, { id: this.state.cbId, type: 'checkbox', onChange: this.changeValue, checked: this.state.value, disabled: disabled }),
        React.createElement(
          'label',
    ...
    value: function render() {
      ...
      var radios = _options.map(function (it, key) {
        ...
        return React.createElement(
          ...
          React.createElement(Radio, { value: _value, id: _name, disabled: disabled }),
          React.createElement(
            'label',
            { htmlFor: _name },
            _value
...
var RkFormInput = function (_Component) {
  ...
  createClass(RkFormInput, [{
    ...
    value: function selectTypeInput(inputProps, rules) {
      ...
      switch (type) {
        case 'multiSelect':
          opt = React.createElement(RkMultiSelect, { inputProps: input, rules: rules, changed: this.changed, getFunctions: this.props.inputFunctions, tooltip: this.props.tooltip });
          break;
        case 'multiSelectTag':
          opt = React.createElement(RkMultiSelectTag, { inputProps: input, rules: rules, changed: this.changed, getFunctions: this.props.inputFunctions, tooltip: this.props.tooltip });
          break;
        case 'multiSelectAdd':
          opt = React.createElement(RkMultiSelectAdd, { inputProps: input, rules: rules, changed: this.changed, getFunctions: this.props.inputFunctions, tooltip: this.props.tooltip });
          break;
        case 'switch':
          opt = React.createElement(RkSwitch, { inputProps: input, changed: this.changed, getFunctions: this.props.inputFunctions, tooltip: this.props.tooltip });
          break;
        case 'checkbox':
          opt = React.createElement(RkCheckbox, { inputProps: input, changed: this.changed, getFunctions: this.props.inputFunctions, tooltip: this.props.tooltip });
          break;
        case 'radio':
          opt = React.createElement(RkRadio, { inputProps: input, rules: rules, changed: this.changed, getFunctions: this.props.inputFunctions, tooltip: this.props.tooltip });
          break;
        case 'datetime':
          opt = React.createElement(RkDatetime, { inputProps: input, rules: rules, changed: this.changed, getFunctions: this.props.inputFunctions, tooltip: this.props.tooltip });
          break;
        case 'plainText':
    ...
    value: function render() {
      ...
      field.map(function (item, key) {
        ...
        var labelTag = labelText ? React.createElement(
          Label,
        ...
        var formGroup = React.createElement(
          Col,
      ...
      if (formGroups.length > 1) {
        resultFormGroup = React.createElement(
          Col,
          null,
          React.createElement(
            Row,
  ...
  createClass(RkForm, [{
    ...
    value: function render() {
      ...
      var _inputs = Object.keys(FormInputs).map(function (key) {
        ...
        return React.createElement(RkFormInput, { key: key, disabled: _this3.props.isLoading, tooltip: _this3.state.tooltip, fields: fInput, render: render, changed: _this3.inputChanged, inputFunctions: _this3.inputFunctions });
      });
