  ...
  createClass(RkForm, [{
    ...
    value: function render() {
      ...
      var _inputs = Object.keys(FormInputs).map(function (key) {
        ...
        return React.createElement(RkFormInput, { key: key, tooltip: _this3.state.tooltip, fields: fInput, render: render, changed: _this3.inputChanged, inputFunctions: _this3.inputFunctions });
      });
